        ...
        <div class="container">
            <form action="{{ route('dashboard.users.store') }}" method="post" class="">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col col-9">
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Ex.: Maria de Almeida" value="{{ old('name') }}" required min="3" max="191">
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col col-3">
                    ...
                    <div class="col col-9">
                        <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" placeholder="Ex.: maria@email.com" value="{{ old('email') }}" required min="5" max="191">
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col col-3">
